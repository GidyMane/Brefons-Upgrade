...
export const NavBar = () => {
  ...
  return (
    <header className="text-gray-600 body-font bg-green-500 fixed top-0 w-full z-50">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <div className="inline-flex title-font font-medium items-left text-gray-900 mb-4 md:mb-0">
          <div className="ml-3 text-2xl text-white"> Build Resilience for Food and Nutrition Security

          </div>

          <div className="flex items-left px-40 space-x-4">
            <button className="inline-flex items-center bg-gray-100 text-green-600 border-0 py-1 px-3 focus:outline-none rounded-md text-base mt-4 md:mt-0 hover:cursor-pointer">
              <FiMapPin className="mr-1" /> Maps
            </button>
            <button onClick={async() => {
              await signOut()
            }} className="inline-flex items-center bg-gray-100 text-green-600 border-0 py-1 px-3 focus:outline-none rounded-md text-base mt-4 md:mt-0 hover:cursor-pointer">
              logout          </button>
